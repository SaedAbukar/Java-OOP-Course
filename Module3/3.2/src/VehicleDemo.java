public class VehicleDemo {
    public static void main(String[] args) {
        ...
        AbstractVehicle electricCar = new ElectricCar("Electric", "Yellow", false, 30000, 120, 50, 5);
        AbstractVehicle electricMotorcycle = new ElectricMotorcycle("Electric", "Gold", false, 70000, 330, 20, 5);
